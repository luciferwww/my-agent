...
describe('AnthropicMessagesClient', () => {
  describe('constructor', () => {
    it('creates client with apiKey', () => {
      expect(new AnthropicMessagesClient({ apiKey: 'test-key' })).toBeDefined();
    });

    it('creates client with baseURL', () => {
      expect(new AnthropicMessagesClient({
        apiKey: 'test-key',
  ...
  describe('chat', () => {
    it('collects text_delta events into a single text block', async () => {
      const client = new AnthropicMessagesClient({ apiKey: 'test-key' });
