...
export function createListDirTool(agentHome: string): Tool {
  return {
    name: 'list_dir',
    description: 'List the direct children of a selected directory.',
    inputSchema: {
      type: 'object',
      properties: {
        path: {
          type: 'string',
          description: 'Agent Home-relative or absolute directory path.',
        },
      },
      required: ['path'],
    },
