...
- [core-runner-design.md](core-runner-design.md) — AgentRunner 设计文档（§9 后续优化：Steer）
- [adapters-channel-design.md](adapters-channel-design.md) — Channel 层设计（SessionGuard、并发策略）
