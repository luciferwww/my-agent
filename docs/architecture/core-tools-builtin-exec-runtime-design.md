...
> 当前状态：截至 2026-04-06，本文中的 `v2.1` 核心底座已经落地到 `src/core/tools/builtin/exec/resolve-command-invocation.ts`、`kill-process-tree.ts`、`run-command.ts`、`process.ts`，并补了对应单测和集成脚本。本文保留为实现后的运行时设计基线。
...
- [../../src/core/tools/builtin/exec/exec.ts](../../src/core/tools/builtin/exec/exec.ts)
- [../../src/core/tools/builtin/exec/process.ts](../../src/core/tools/builtin/exec/process.ts)
- [../../src/core/tools/builtin/exec/run-command.ts](../../src/core/tools/builtin/exec/run-command.ts)
- [../../src/core/tools/builtin/exec/process-registry.ts](../../src/core/tools/builtin/exec/process-registry.ts)
- [../../src/core/tools/builtin/exec/resolve-command-invocation.ts](../../src/core/tools/builtin/exec/resolve-command-invocation.ts)
- [../../src/core/tools/builtin/exec/kill-process-tree.ts](../../src/core/tools/builtin/exec/kill-process-tree.ts)
...
- [../../src/core/tools/builtin/exec/run-command.ts](../../src/core/tools/builtin/exec/run-command.ts)
- [../../src/core/tools/builtin/exec/process.ts](../../src/core/tools/builtin/exec/process.ts)
- [../../src/core/tools/builtin/exec/exec-types.ts](../../src/core/tools/builtin/exec/exec-types.ts)
